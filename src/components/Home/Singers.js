...
export default function Singer() {
  ...
  return (
    ...
    <section className="min-h-screen py-10 mt-10 py-20 px-4" data-aos='fade-up-right' data-aos-delay="10">
      ...
      <div className='flex flex-col lg:flex-row px-10 gap-6 items-center justify-center py-10 px-6 '  >

          {
              singer.map((items)=>(
                ...
                <div  key={items.sl} className='border-2 border-orange-300 backdrop-blur py-2 px-2'>
                  <img className='h-[150px] w-[150px] lg:h-[200px] lg:w-[200px] rounded-full' src={items.img}></img>
                  <div className='flex flex-col items-center justify-center'>
                    <h2 className='singerHead text-center text-white text-2xl'>{items.Name}</h2>
              ...
              <img className='relative left-[100px] lg:left-[15px] rocket  h-36' src={rocket} alt='avatar'></img>
